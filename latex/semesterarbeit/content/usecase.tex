...
Einerseits soll dieser Arbeit mittels POC\footnote{Prove of Concept} aufgezeigt werden, wie der Automatisierungsgrad erhöht werden könnte. Andererseits soll untersucht werden, ob anstelle von EC2 direkt Spot Instanzen für die Prozessierung verwendet werden können und wie deren Einsatz aussehen könnte.
