...
Einerseits soll in dieser Arbeit mittels POC\footnote{Prove of Concept} aufgezeigt werden, wie der Automatisierungsgrad erhöht werden könnte. Andererseits soll untersucht werden, ob anstelle von EC2 direkt Spot Instanzen für die Prozessierung verwendet werden können und wie deren Einsatz aussehen könnte.

\subsubsection{Spot Instanzen}
TODO: Theorie - was sind Spot Instanzen und wie stehen diese im Verhältnis zu Problemstellung? Wie soll damit umgegangen werden, dass die Instanz jederzeit verschwinden könnte?
\begin{itemize}
\item REST Abfrage
\item Cloud Watch
