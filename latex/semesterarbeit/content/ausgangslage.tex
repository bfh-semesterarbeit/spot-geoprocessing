...
\item \textbf{Abb. \ref{fig:ist_zustand}, Schritt 6.}: Via Docker. Der Container wurde von der Firma Analytical Graphics Inc. \cite{AGI2010} bereitgestellt. Das Tool, dass die Rohdaten in ein Web-Format umwandelt, wird mit Node.js ausgeführt.
