...
Das Aufzeigen des Prozesses der Publikation soll helfen einen Überblick der Arbeiten zu erhalten, die erledigt werden müssen, um die 3D Daten im Web zu publizieren. Es bildet den Ist-Zustand ab und erleichtert es mögliche Schritte, die automatisiert werden können, zu identifizieren.
Sobald der Auftrag für eine 3D Datenpublikation erteilt wurde\footnote{vom Bereich Topografie}, müssen zurzeit folgende Schritte, die im Anhang TODO referenziert sind, erledigt werden. 

\begin{figure}[H]
	\centering
	\includegraphics[width=.80\textwidth]{ist_zustand}
...
\item Die Daten zum Testen bereitstellen. Ein Codepen Projekt, dass auf die Tiles zugreift
\end{enumerate}
