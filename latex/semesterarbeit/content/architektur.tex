...
Bei der Provisionierung\footnote{Bereitstellung.} des Servers wurde der \emph{"Cloud-init"} Ansatz gewählt: Dieser Ansatz richtet das Ubuntu Image in der Startup Phase des Servers ein. Dies hat gegenüber einem eigenen AMI den Vorteil, dass die Spezialisierung\footnote{Das Einrichten.} deklatrativ festgehalten wird. Ausserdem muss bei einem Update des Basis Images kein neues Image gebaut werden.
